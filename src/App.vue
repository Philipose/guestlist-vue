...
<template>
    <div class="max-w-4xl mx-auto py-5">
      ...
      <a href="https://weduploader.com/upload/PS8XpsktOLhehI2a" class="w-full flex text-center text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">UPLOAD PHOTOS HERE!</a>
    </div>
...
.customize-table {
  ...
  --easy-table-footer-background-color: #8C9473;
